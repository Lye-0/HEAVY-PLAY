...
export class Playground {
 ...
 reset(){if(this.rebuilding)return;this.input.clear();this.dropQueue=0;this.waves=[];this.paused=false;this.accumulator=0;const count=PRESETS[this.quality].count;this.world.bodies.length=count;this.lastInteraction=performance.now();this.revealHero();
